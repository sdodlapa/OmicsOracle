...
class TestCacheDBMaintenance:
    ...
    def test_update_access_time(self, db):
        ...
        # Add entry
        db.add_entry(
            publication_id="PMC123456", file_path="/data/test.pdf", file_type="pdf", file_source="pmc"
        )
    ...
    def test_vacuum(self, db):
        ...
        for i in range(10):
            db.add_entry(
                publication_id=f"PMC_{i}", file_path=f"/data/test_{i}.pdf", file_type="pdf", file_source="pmc"
            )
