...
def pubmed_config():
    ...
    return PubMedConfig(email="test@example.com", max_results=10)
...
class TestPipelineInitialization:
    ...
    def test_pubmed_client_not_initialized_when_disabled(self, pubmed_config):
        ...
        config = PublicationSearchConfig(enable_pubmed=False, pubmed_config=pubmed_config)
...
class TestSearchFunctionality:
    ...
    def test_search_deduplicates_results(self, mock_search, basic_config):
        ...
        duplicate_pub = Publication(pmid="12345", title="Test", source=PublicationSource.PUBMED)
...
class TestInstitutionalAccessIntegration:
    ...
    def test_institutional_access_enrichment(self, mock_search):
        ...
        pub = Publication(
            pmid="12345", doi="10.1038/test.123", title="Test publication", source=PublicationSource.PUBMED
        )
...
class TestDeduplication:
    ...
    def test_deduplicate_by_pmid(self, basic_config):
        ...
        pub1 = Publication(pmid="12345", title="Same publication", source=PublicationSource.PUBMED)
        pub2 = Publication(pmid="12345", title="Same publication", source=PublicationSource.PUBMED)
    ...
    def test_deduplicate_by_doi(self, basic_config):
        ...
        pub1 = Publication(doi="10.1038/test.123", title="Same publication", source=PublicationSource.PUBMED)
        pub2 = Publication(
            doi="10.1038/test.123", title="Same publication", source=PublicationSource.GOOGLE_SCHOLAR
        )
    ...
    def test_deduplicate_keeps_unique(self, basic_config):
        ...
        pub1 = Publication(pmid="12345", title="Publication 1", source=PublicationSource.PUBMED)
        pub2 = Publication(pmid="67890", title="Publication 2", source=PublicationSource.PUBMED)
