...
def mock_entrez_search_result():
    ...
    return {"IdList": ["12345678", "87654321", "11111111"], "Count": "3", "RetMax": "3"}
    ...
    return {
        "MedlineCitation": {
            ...
            "Article": {
                ...
                "Journal": {"Title": "Nature Biotechnology", "ISOAbbreviation": "Nat Biotechnol"},
                "ArticleDate": [{"Year": "2024", "Month": "03", "Day": "15"}],
            },
            "MeshHeadingList": [
...
class TestPubMedSearch:
    ...
    def test_search_returns_publications(
        self, mock_efetch, mock_esearch, pubmed_client, mock_entrez_search_result, mock_medline_record
    ):
        ...
        with patch("omics_oracle_v2.lib.publications.clients.pubmed.Entrez.read") as mock_read:
            mock_read.side_effect = [mock_entrez_search_result, [mock_medline_record]]
...
class TestPubMedFetch:
    ...
    @patch("omics_oracle_v2.lib.publications.clients.pubmed.Entrez.efetch")
    def test_fetch_by_id_returns_publication(self, mock_efetch, pubmed_client, mock_medline_record):
...
class TestPubMedParsing:
    ...
    def test_parse_medline_record_extracts_title(self, pubmed_client, mock_medline_record):
    ...
    def test_parse_medline_record_extracts_pmid(self, pubmed_client, mock_medline_record):
    ...
    def test_parse_medline_record_extracts_doi(self, pubmed_client, mock_medline_record):
    ...
    def test_parse_medline_record_extracts_authors(self, pubmed_client, mock_medline_record):
    ...
    def test_parse_medline_record_extracts_mesh_terms(self, pubmed_client, mock_medline_record):
