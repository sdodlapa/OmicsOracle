...
from omics_oracle_v2.api.routes.analytics import router as analytics_router
...
from omics_oracle_v2.api.routes.predictions import router as predictions_router
from omics_oracle_v2.api.routes.recommendations import router as recommendations_router
