...
from omics_oracle_v2.lib.workflows import GEOCitationConfig, GEOCitationPipeline
...
async def test_pipeline():
    ...
    # Run collection
    try:
        result = await pipeline.collect(query=query, max_datasets=2, max_citing_papers=20)
