...
class SemanticRanker:
    ...
    TECHNIQUE_SYNONYMS = {
        "dna methylation": [
            "5mc", "5-methylcytosine", "bisulfite sequencing", "bisulfite-seq",
            "wgbs", "whole genome bisulfite sequencing", "rrbs", 
            "reduced representation bisulfite sequencing", "methylc-seq",
            "nome-seq", "nucleosome occupancy and methylome sequencing"
        ],
        "chromatin accessibility": [
            "atac-seq", "assay for transposase-accessible chromatin",
            "dnase-seq", "dnase hypersensitivity", "faire-seq",
            "formaldehyde-assisted isolation of regulatory elements",
            "mnase-seq", "nome-seq"
        ],
        "hi-c": [
            "3d genome", "chromatin conformation", "chromosome conformation capture",
            "genome architecture", "chromatin architecture", "spatial genome organization"
        ],
        "rna-seq": [
            "transcriptome", "gene expression profiling", "rna sequencing",
            "transcriptomics", "mrna-seq"
        ],
        "single-cell": [
            "sc-", "single cell", "drop-seq", "10x genomics", "10x",
            "cell-level", "single-nucleus"
        ],
        "joint profiling": [
            "multi-omics", "multiomics", "simultaneous profiling",
            "integrated profiling", "coupled assay", "combined profiling",
            "co-profiling", "nmt-seq", "nome-seq", "sci-met"
        ]
    }
